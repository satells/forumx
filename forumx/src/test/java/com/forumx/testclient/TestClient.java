...
//		post();
	...
	private static void delete() throws Exception {
		...
		try (CloseableHttpClient httpclient = HttpClients.createDefault()) {
			HttpDelete httppost = new HttpDelete("http://localhost:8080/topicos/3");
	...
	private static void post() throws Exception {
		...
		try (CloseableHttpClient httpclient = HttpClients.createDefault()) {
			HttpPost httppost = new HttpPost("http://localhost:8080/topicos");
			httppost.setHeader("Authorization", "Bearer " + TOKEN_MODERADOR);
	...
	private static void get() throws IOException {
		...
		String conteudo = Request.get("http://localhost:8080/topicos/3")
